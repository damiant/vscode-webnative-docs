...
The following scenarios will show a recommendation:
...
- When a plugin is not required (e.g., `cordova-plugin-add-swift-support`)

:::note
Not all scenarios are covered, so if there is a fix you've needed to apply to your project that you think would be of benefit to other developers please [submit a suggestion](https://github.com/damiant/vscode-webnative/issues).
:::