...
<Video aspectRatio="3.3 / 2" src="https://videos.webnative.dev/webnative-app.mp4" alt="WebNative App" controls />
...
Your computer and mobile device must be on the same Wi‑Fi network. Your dev server should be serving on an external IP address.
