...
<Video src="https://videos.webnative.dev/bundle-analysis.mp4" alt="Bundle Analysis" controls />

## Bundle Cost

Click `Configuration` > `Statistics` to see a page breaking down the size of each JavaScript bundle.
